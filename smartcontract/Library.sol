...
contract DecentralizedLibrary {
    ...
    function _viewBalance() public view returns (uint256) {
...
//required functions
//1. allow a customer to upload (for upload page)
//2. return an array of all the items uploaded by a customer (for private page)
//3. return an array of all items inside the library (for home page)
//4. return the balance of the address calling the upload/subsequent upload function
//5. check if an account has uploaded before